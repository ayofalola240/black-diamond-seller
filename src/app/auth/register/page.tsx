...
export default function Register() {
  ...
  return (
    <section className="min-h-screen py-[58px] gap-[38px] px-4 flex flex-col items-center bg-auth-bg bg-cover w-full">
      ...
      <Form {...form}>
        <form id="register-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 max-w-[468px] mx-auto w-full">
          <FormField
      ...
      <Button form="register-form" type="submit" disabled={isPending} className="w-full max-w-[468px] mx-auto mt-[20px] sm:mt-[100px]">
